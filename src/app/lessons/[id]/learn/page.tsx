...
export default async function LearnLessonPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <main className="py-12 px-4 sm:px-6 lg:px-8 font-sans bg-white min-h-screen">
            <div className="max-w-7xl mx-auto">
                ...
                <VocabularyFlashcards words={words} initialProgress={progress} lessonId={lessonId} initialMode="learn" />
            </div>
        </main>
    );
}
