    ...
    const handleSave = async (sentenceId: number) => {
        ...
        startTransition(async () => {
            try {
                ...
                toast.error("Failed to update conversation sentence. Please try again.");
            }
        });
    };
    ...
    const handleCreate = async () => {
        ...
        startTransition(async () => {
            try {
                ...
                toast.error("Failed to add conversation sentence. Please try again.");
            }
        });
    };
    ...
    const handleDelete = async (sentenceId: number) => {
        startTransition(async () => {
            try {
                ...
                toast.error("Failed to delete conversation sentence. Please try again.");
                setDeletingId(null);
            }
        });
    };
    ...
    const handleBulkAdd = async () => {
        ...
        startTransition(async () => {
            try {
                ...
                toast.error("Failed to add conversation sentences. Please try again.");
            }
        });
    };
        ...
        if (over && active.id !== over.id) {
            ...
            startTransition(async () => {
                try {
                    ...
                    toast.error("Failed to update conversation order. Please try again.");
                    // Revert on error
